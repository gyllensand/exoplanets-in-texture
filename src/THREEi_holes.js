...
//   "use strict";
  ...
  export function createSphereWithHoles(arg1, arg2) {
    ...
    if (arg1.d > 0) {
      ...
      // variant detail, holes are optional, radius = 1 is fixed - use three.js .scale
  ...
  export function buildSphereWithHolesObj() {
    const dd = g.d * g.d;
    ...
    while (frontStock > 0) {
      if (!unite) {
        ...
        // unite the active front to another front
